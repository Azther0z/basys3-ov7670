...
module display_scaler (
    ...
    // BRAM Port B (read)
    input  wire [11:0] rd_data,    // {R[3:0], G[3:0], B[3:0]}
    ...
    // Mathematical transformation for "Rotate 90 CCW":
    // Original image: 320(W) x 240(H)
    // img_x = 319 - rot_y
    // img_y = rot_x
    wire [8:0] img_x = 9'd319 - rot_y; // 319 to 0

...
module ov7670_config (
    ...
    // -----------------------------------------------------------------------
    localparam N_REGS = 70; // Optimized register list
    ...
    always @(*) begin
        case (rom_idx)
            ...
            // 3. Format & Scaling
            7'd4:  current_reg = {8'h12, 8'h04}; // COM7: RGB + VGA mode natively
            7'd5:  current_reg = {8'h40, 8'hD0}; // COM15: RGB + Full Range
            ...
            7'd69: current_reg = {8'h8c, 8'h02}; // RGB444 enable, xR GB format
